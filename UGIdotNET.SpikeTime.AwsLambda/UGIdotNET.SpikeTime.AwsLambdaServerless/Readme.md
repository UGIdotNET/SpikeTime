...
Execute unit tests
```
    cd "UGIdotNET.SpikeTime.AwsLambdaServerless/test/UGIdotNET.SpikeTime.AwsLambdaServerless.Tests"
    dotnet test
```

Deploy application
```
    cd "UGIdotNET.SpikeTime.AwsLambdaServerless/src/UGIdotNET.SpikeTime.AwsLambdaServerless"
