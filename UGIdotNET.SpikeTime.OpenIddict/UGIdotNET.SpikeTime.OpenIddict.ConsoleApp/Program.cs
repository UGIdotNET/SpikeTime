...
Console.WriteLine("Hello, OpenIddict!");
...
services.AddOpenIddict()
    ...
    .AddClient(options =>
    {
        ...
        {
            Issuer = new Uri("https://localhost:7146/", UriKind.Absolute),
...
static async Task<string> GetResourceAsync(IServiceProvider provider, string token)
{
    ...
    using var request = new HttpRequestMessage(HttpMethod.Get, "https://localhost:7146/api/message");
